<%@ Control Language="C#" CodeBehind="DefaultLGS.ascx.cs" ClassName="DefaultLGS" Inherits="dola.Web.DefaultLGS" %>
...
<%@ Register Assembly="DevExpress.ExpressApp.Web.v20.1, Version=20.1.17.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.ExpressApp.Web.Templates.ActionContainers"
    TagPrefix="xaf" %>
<%@ Register Assembly="DevExpress.ExpressApp.Web.v20.1, Version=20.1.17.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.ExpressApp.Web.Templates"
    TagPrefix="xaf" %>
<%@ Register Assembly="DevExpress.ExpressApp.Web.v20.1, Version=20.1.17.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.ExpressApp.Web.Controls"
    TagPrefix="xaf" %>
<%@ Register Assembly="DevExpress.ExpressApp.Web.v20.1, Version=20.1.17.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.ExpressApp.Web.Templates.Controls"
    TagPrefix="xaf" %>
...
<div id="TestheaderTableDiv" style="background-color: whitesmoke; position: absolute; display: none; right: 0px; z-index: 100000">
</div>
...
<div id="footer" class="xafFooter width100">
      ...
      Copyright©2020  <img  src="Images/dola.png" width="60";>  Teknoloji A.Ş.  (Version:2.0.0.0)</div> 
</div>
